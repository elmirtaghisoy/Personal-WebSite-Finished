...
function arlo_tm_anchor(){
	...
	jQuery('.arlo_tm_leftpart .inner .menu1 ul li a,.arlo_tm_topbar .dropdown .dropdown_inner ul li a,.arlo_tm_topmenu .topmenu_inner .menu ul li a').off().on('click',function(e){
		e.stopPropagation();
...
function arlo_tm_animate_text(){
	...
	var animateSpan			= jQuery('.arlo_tm_animation_text_word');
		...
		animateSpan.typed({
			strings: ["Java Developer", "Freelancer"],
			loop: true,
			startDelay: 1e3,
			backDelay: 2e3
		});
